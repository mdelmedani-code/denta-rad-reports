      ...
      const { data, error } = await supabase.functions.invoke('generate-pdf-report', {
        body: {
          ...
          caseData: {
            ...
            urgency: 'standard',
            clinical_question: 'Evaluate impacted third molars and assess bone density for implant placement in lower left quadrant. Patient reports intermittent pain and swelling in the area.',
            upload_date: new Date().toISOString(),
            clinic_name: 'Downtown Dental Clinic (Preview)',
            clinic_contact_email: 'info@downtowndental.com'
          },
          reportText: `CBCT SCAN ANALYSIS AND DIAGNOSTIC FINDINGS

OVERVIEW:
The cone beam computed tomography (CBCT) scan provides detailed three-dimensional imaging of the patient's oral and maxillofacial structures. This comprehensive analysis evaluates the requested areas of concern.

CLINICAL FINDINGS:

Third Molars Assessment:
• Lower left third molar (#17) appears impacted with mesioangular orientation
• Adequate follicular space noted around crown
• Root development appears complete with normal morphology
• No evidence of pathology or cystic changes

Bone Density Analysis:
• Lower left quadrant shows Type D2 bone quality (moderate density)
• Cortical bone thickness measures approximately 1.2mm buccally and 2.1mm lingually  
• Trabecular bone pattern appears normal with good vascularization
• No evidence of sclerotic changes or pathology

Implant Planning Considerations:
• Available bone height: 12.5mm from alveolar crest to inferior alveolar canal
• Available bone width: 8.2mm at the proposed implant site
• Distance to adjacent tooth roots: adequate (>2mm clearance)
• Sinus floor relationship: not applicable for lower arch

Additional Observations:
• No signs of active infection or inflammation
• Lamina dura intact around existing teeth
• No evidence of bone loss or periodontal disease in the area
• Normal anatomical landmarks identified
